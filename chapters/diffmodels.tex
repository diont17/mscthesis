...
\caption[Different predictions of Luz-Meiboom and Jensen Chandra models]{Different predictions of Luz-Meiboom and Jensen Chandra models. Parameters used are \Kzero = \Gzero = \SI{e-14}{T^2}, \Texc = \SI{4}{ms}, \rc = \SI{4}{\micro\metre}, D=\SI{2e3}{\micro\metre\per\second\squared}. The parameter $\tau_ex = \frac{r_c^2}{2D} = \SI{4}{ms}$.}
