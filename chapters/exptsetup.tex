...
As discussed in the TODO background.., the experiment uses two gradient pulses to encode displacement into the phase of the spin echo, so that with knowledge of the phase difference and $\Delta$, the velocity of the spins can be determined.
