...
The second magnet system used was the NMR MOLE, previously developed by Manz et al.\cite{ManzmobileonesidedNMR2006} (\autoref{fig:exptsetup-nmrmole}).
...
\includegraphics[height=5cm]{figures/exptsetup/probe.JPG}
\caption{Probe assembly}
\label{fit:exptsetup-probe}
\end{subfigure}
\hspace{0.6cm}
\begin{subfigure}[t]{0.5\textwidth}
\includegraphics[height=5cm]{figures/exptsetup/circuit.jpg}
\caption{Exchangeable coils and capacitor boards}
...
To investigate variations in the flow rate, the pulse sequence also allows for a single reference measurement (where \textit{g}=\SI{0}{T/m}) followed by repetitions of the same \textit{g}-step.
...
\begin{figure}[t]
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.3\textwidth]{figures/exptsetup/oximetercal.pdf}}
