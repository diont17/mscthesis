...
\caption[Generation of a Spin echo]{Applying a \SI{180}{\degree} pulse a time $\tau$ after a \SI{90}{\degree} pulse produces a spin echo at time $2\tau$, as the different accumulated phases are unwound.}
